...
<script>
    export default {
        ...
        mounted() {
            ...
            let ranges = this.d3.range(dataset.length); // 产生一系列的数值[0,1,2,3...9]
            let xcale = this.d3.scaleBand().domain(ranges).range([0, width - marge.left - marge.right]); // 480/10=48
            ...
            // 设置矩形之间的间隙
            let rectPadding = 20;
            let colorData = ['#0098FC', '#0098FD', '#0098FE', '#0098FF'];
            ...
            //     canvasCtx.fillStyle = colorData[index];
